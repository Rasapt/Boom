    ...
    <div className="min-h-screen flex flex-col bg-[var(--surface)]">
      <div className="flex-1 flex flex-col items-center justify-center text-center px-8">
        ...
        <div className="flex flex-col items-center mb-6">
          <div className="w-20 h-20 rounded-3xl bg-[var(--accent)] flex items-center justify-center mb-4 shadow-lg">
        ...
        <p className="text-[var(--muted)] text-[15px] leading-relaxed max-w-[280px]">
          برنامه‌ریز هوشمند شخصی‌سازی‌شده برای دانش‌آموزان ایرانی آماده کنکور.
        </p>
        <p className="mt-2 text-[var(--muted-2)] text-[13px] leading-relaxed max-w-[260px]">
          تکالیف روزانه، پیگیری پیشرفت، و دستیاری که سبک مطالعه‌ات رو یاد می‌گیره.
        </p>
      </div>
      ...
      <div className="flex flex-col items-center gap-4 px-8 pb-14">
        <button
          onClick={() => nav("signup")}
          className="w-full max-w-xs py-[15px] rounded-2xl bg-[var(--accent)] text-[var(--surface)] font-bold text-[15px] hover:bg-[#A85C38] active:scale-95 transition-all shadow-sm"
        >
          ایجاد حساب کاربری
        </button>
        <button
